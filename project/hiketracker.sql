...
insert into Preference values (00005, 14, 4, 600, 7);
...
insert into AppUser values (00005, 'Elon Musk', 00005, 'elon@example.com', '1234567895');
...
insert into Hike1 values ('Ridge Walk', 9, 450, 200, 6);
insert into Hike1 values ('Alpine Pass', 18, 1200, 300, 8);
insert into Hike1 values ('Lakeside', 5, 120, 70, 2);
insert into Hike1 values ('Canyon Run', 14, 700, 210, 7);
...
insert into Location1 values ('T2P3G5', 'Canada', 'British Columbia', 'Richmond');
insert into Location1 values ('T0L1K0', 'Canada', 'British Columbia', 'Yarrow');
insert into Location1 values ('V1Y8K6', 'Canada', 'British Columbia', 'Kelowna');
insert into Location1 values ('V1N2P3', 'Canada', 'British Columbia', 'Nelson');
...
insert into Location2 values (00005, '200 Ridge Walk', 'T2P3G5', 'Canada', 51.04860000, -114.07080000);
insert into Location2 values (00006, '15 Alpine Pass', 'T0L1K0', 'Canada', 51.08990000, -115.35400000);
insert into Location2 values (00007, '9 Lakeside Loop', 'V1Y8K6', 'Canada', 49.88800000, -119.49600000);
insert into Location2 values (00008, '300 Canyon Run', 'V1N2P3', 'Canada', 49.49340000, -117.29400000);
...
insert into Hike2 values (00005, 00005, 'Pine Ridge Loop', 'Ridge Walk', 'Spring', 7, 200, 450, 9);
insert into Hike2 values (00006, 00008, 'Granite Canyon Run', 'Canyon Run', 'Fall', 8, 210, 700, 14);
insert into Hike2 values (00007, 00006, 'Skyline Alpine Pass', 'Alpine Pass', 'Winter', 6, 300, 1200, 18);
insert into Hike2 values (00008, 00007, 'Blue Lake Circuit', 'Lakeside', 'Summer', 9, 70, 120, 5);
...
insert into Feedback values (00005, 5, 'Spring flowers made this loop unforgettable.', TO_DATE('2025-09-20', 'YYYY-MM-DD'), 00005, 00005);
insert into Feedback values (00006, 2, 'Windy ridges but great challenge.', TO_DATE('2025-10-05', 'YYYY-MM-DD'), 00001, 00007);
...
insert into Needs values (00001, 00005);
insert into Needs values (00002, 00006);
insert into Needs values (00003, 00007);
insert into Needs values (00000, 00008);
...
insert into Saves values (00000, 00001);
insert into Saves values (00000, 00004);
insert into Saves values (00000, 00007);
insert into Saves values (00001, 00002);
insert into Saves values (00001, 00005);
insert into Saves values (00001, 00007);
insert into Saves values (00002, 00003);
insert into Saves values (00002, 00005);
insert into Saves values (00002, 00007);
insert into Saves values (00003, 00001);
insert into Saves values (00003, 00006);
insert into Saves values (00004, 00002);
insert into Saves values (00004, 00003);
insert into Saves values (00004, 00006);
insert into Saves values (00004, 00008);
insert into Saves values (00005, 00000);
insert into Saves values (00005, 00001);
insert into Saves values (00005, 00002);
insert into Saves values (00005, 00003);
insert into Saves values (00005, 00004);
insert into Saves values (00005, 00005);
insert into Saves values (00005, 00006);
insert into Saves values (00005, 00007);
insert into Saves values (00005, 00008);
...
insert into Has values (00005, 00008);
insert into Has values (00006, 00003);
insert into Has values (00006, 00004);
insert into Has values (00007, 00002);
